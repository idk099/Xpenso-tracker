...
class _SigninState extends State<Signin> {
  ...
  List<Color> dark = [Colors.red, Colors.blue];
  List<Color> light = [Colors.black, Colors.white];
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
              gradient: LinearGradient(colors: islightmode ? dark : light)),
          child: Column(
            children: [
              Image.asset(
              ...
              Expanded(
                child: Container(
                  decoration: BoxDecoration(
                      color: islightmode
                          ? Colors.white
                          : const Color.fromARGB(255, 19, 6, 6),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _loading
                                  ...
                                  : Text(
                                      "SUBMIT",
                                      style: TextStyle(color: islightmode ? Colors.white : Colors.black),
                                    ),
                            ),
                          ),
                          const SizedBox(height: 20),
    ...
    if (_formkey.currentState!.validate()) {
      ...
      try {
        ...
        if (e.code == 'user-not-found') {
          Get.snackbar('USER NOT FOUND', 'Register to continue',
