...
class _ForgotState extends State<Forgot> {
  ...
  final Authenticate _auth = Authenticate();
    bool _loading = false;
      List<Color> light = [ Color.fromARGB(255, 8, 186, 199),
          Color.fromARGB(255, 226, 15, 230)];
  List<Color> dark = [Colors.black, const Color.fromARGB(255, 237, 185, 185)];
  @override
  Widget build(BuildContext context) {
    return Container(
        decoration:  BoxDecoration(
            gradient: LinearGradient(colors:Theme.of(context).brightness==Brightness.light?light:dark
