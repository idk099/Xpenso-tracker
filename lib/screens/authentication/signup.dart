...
class _SignupState extends State<Signup> {
  ...
  bool _loading = false;
  Image? background;
   List<Color> dark = [Colors.blueGrey, Colors.grey];
  List<Color> light = [Colors.green, Colors.yellow];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(colors:islightmode ? light:dark )
        ),
          child: Column(
            children: [
              Image.asset(
              ...
              Expanded(
                child: Container(
                  decoration:  BoxDecoration(
                      color:islightmode ? Colors.white : Theme.of(context).primaryColor,
